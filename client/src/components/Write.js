      ...
      <div className="board__create--content">
        ...
        <div className="board__NFT--container">
          ...
          <dl className="board__write--NFTname">
            <dt>NFT Name</dt>
            <dd>
              <input className="board__NFT--name" ref={nameInput} name="name" value={state.name} type="text" placeholder="이름 입력" onChange={handleChangeState}></input>
            </dd>
      ...
      <div className="board__write--container">
        <div className="board__write">
          ...
          <div className="board__write--cont">
            <textarea ref={contentInput} name="content" placeholder="내용 입력" value={state.content} onChange={handleChangeState}></textarea>
          </div>
        </div>
